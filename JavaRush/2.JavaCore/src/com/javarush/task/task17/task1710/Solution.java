...
/*
Закоментил свое решение и написал то, которое принял валидатор.
Класс PersonInspector - мой
 */
...
//        PersonInspector inspector = new PersonInspector();
//        String data = "";
//
//        for (String s : args) data += s + " ";
//        inspector.analyze(data);
