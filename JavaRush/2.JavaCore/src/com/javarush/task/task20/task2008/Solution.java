...
public class Solution implements Serializable {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        try (ByteArrayOutputStream byteArrayOutputStream = serializeSingletonInstance(instance)) {

            singleton = deserializeSingletonInstance(byteArrayOutputStream);
            singleton1 = deserializeSingletonInstance(byteArrayOutputStream);
        }
